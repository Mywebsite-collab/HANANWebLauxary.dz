...
function updateSummaryDeliveryPriceUI(newDeliveryPrice, isBundle = false) {
  ...
  if (deliveryPriceElement) deliveryPriceElement.textContent = newDeliveryPrice;
}
...
function updateSummaryTotalPriceUI(isBundle = false) {
  ...
  const deliveryPriceValue = deliveryPriceElement ? parseInt(deliveryPriceElement.textContent) : 0;
  let totalPrice = 0;
